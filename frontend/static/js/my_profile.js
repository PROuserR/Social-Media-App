...
function display_profile(){
    fetch(`https://prouserr.pythonanywhere.com/api/get_profile/${user_id}`).then((resp) => resp.json()).then(function(data){
    ...
    fetch(`https://prouserr.pythonanywhere.com/api/list_user_posts/${user_id}`).then((resp) => resp.json()).then(function(data){
...
function update_user(){
    ...
    fetch(`https://prouserr.pythonanywhere.com/api/update_user/`, {
        method:'POST', 
        headers:{
...
function update_profile(){
    ...
    fetch(`https://prouserr.pythonanywhere.com/api/update_profile/`, {
        method:'POST', 
        headers:{
            'X-CSRFToken':csrftoken,
        },
...
function create_profile(){
    ...
    fetch(`https://prouserr.pythonanywhere.com/api/create_profile/`, {
        method:'POST', 
        headers:{
            'X-CSRFToken':csrftoken,
        },
...
function update_password(){
    ...
    if(newpassword1==newpassword2){
        fetch(`https://prouserr.pythonanywhere.com/api/update_password/`, {
            method:'POST', 
            headers:{
                'Content-type':'application/json',
                'X-CSRFToken':csrftoken,
...
function logout(){
    fetch(`https://prouserr.pythonanywhere.com/api/logout_user`).then(function(){window.location.reload()})
