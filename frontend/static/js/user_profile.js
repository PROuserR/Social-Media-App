...
function display_profile(){
    fetch(`https://prouserr.pythonanywhere.com/api/get_profile/${user_id}`).then((resp) => resp.json()).then(function(profile){
        console.log(profile)
    if(profile.followers.includes(parseInt(my_id))){
        ...
        fetch(`https://prouserr.pythonanywhere.com/api/list_user_posts/${profile.id}`).then((resp) => resp.json()).then(function(data){
...
function follow_user(user_id){
    fetch(`https://prouserr.pythonanywhere.com/api/follow_user/${user_id}`, {
        method:'POST', 
        headers:{
...
function unfollow_user(user_id){
    fetch(`https://prouserr.pythonanywhere.com/api/unfollow_user/${user_id}`, {
        method:'POST', 
        headers:{
            'Content-type':'application/json',
            'X-CSRFToken':csrftoken,
...
if(user_id != my_id){
    ...
    window.location.href = 'https://prouserr.pythonanywhere.com/my_profile/'
}
